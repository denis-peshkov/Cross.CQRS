...
export const TRIAGE_MARKER_LEGACY = '<!-- cross-cqrs-triage -->';

const DEFAULT_REPO = 'denis-peshkov/Cross.CQRS';
...
export function getTriageIconUrl(repo = DEFAULT_REPO, branch = 'master') {
  return `https://raw.githubusercontent.com/${repo}/${branch}/icon.png`;
}
...
export function formatPrTriageComment(data, options = {}) {
  ...
  return `> <img src="${iconUrl}" width="48" height="48" alt="Cross.CQRS"> **Cross.CQRS** · Automated triage by AI
